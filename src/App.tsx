...
import AllProducts from "./pages/products/all/all";
import AllCategories from "./pages/categories/all/all";
import AddCategory from "./pages/categories/add/add";
import ProductDetails from "./pages/products/deails/productDetails";
...
import SettingsPage from "./pages/settings/SettingsPage"; // New Settings Page import
